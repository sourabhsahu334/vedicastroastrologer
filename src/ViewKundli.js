          ...
          <View style={styles.ChartHeadTabBar}>
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  borderColor: Selected == 1 ? Colors.primary : null,
            ...
            <TouchableOpacity
              ...
              style={[
                styles.ChartHeadTabBarButton,
                {
                  borderColor: Selected == 2 ? Colors.primary : null,
            ...
            <TouchableOpacity
              ...
              style={[
                styles.ChartHeadTabBarButton,
                {
                  borderColor: Selected == 3 ? Colors.primary : null,
            ...
            <TouchableOpacity
              ...
              style={[
                styles.ChartHeadTabBarButton,
                {
                  borderColor: Selected == 4 ? Colors.primary : null,
        ...
        <ScrollView>
          ...
          <View style={styles.TableContainer}>
            <View style={styles.TableTop}>
              <Text style={styles.TableHeading}>Planet</Text>
