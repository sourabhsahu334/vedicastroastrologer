...
const Rules = () => {
  const Rules = [
    ...
    '3. Daily online time must be more than 3 hours, on an average',
    '4. Customer satisfaction score must be more than 60%',
    '5. Never share any internal policies with customers',
    '6. Never defame any Astrologer or Vaidic astro anywhere',
    ...
    '3. दैनिक ऑनलाइन समय औसतन 3 घंटे से अधिक होना चाहिए',
    '4. ग्राहक संतुष्टि स्कोर 60% से अधिक होना चाहिए',
    '5. ग्राहकों के साथ कभी भी कोई आंतरिक नीति साझा न करें',
    '6. कभी भी किसी ज्योतिषी या वेदिक एस्ट्रो को कहीं भी बदनाम न करें',
